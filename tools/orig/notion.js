/* Condensed, original digests of Arka Li's DVA-C02 notes (arkalim.notion.site).
   Each topic is paraphrased into exam-focused bullets and mapped to the
   day(s) of the 30-day plan it belongs to. The "url" points to the original
   public page for attribution and deeper reading. */
window.DVA_NOTION = {
  "ec2": {
    "title": "EC2",
    "days": [4],
