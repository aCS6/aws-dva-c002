window.DVA_DAYNOTES = {
 "1": {
  ...
  "table": [
   ...
   [
    "Region",
    "A cluster of AZs in one geography"
   ],
   [
    "AZ",
    "One isolated data-center group (3+ per region)"
   ],
   [
    "Edge location",
    "CDN/DNS cache point, not compute"
   ],
   [
    "Global services",
 ...
 "3": {
  ...
  "table": [
   ...
   [
    "User",
    "A fixed identity for one person or app"
   ],
   [
    "Group",
    "Same permissions for a team of users"
   ],
   [
    "Role",
    "Temporary, assumed access (services, cross-account)"
   ],
   [
    "Policy",
    "The rule that says Allow/Deny"
   ]
  ]
 },
 "4": {
  ...
  "table": [
   ...
   [
    "PassRole",
    "Permission to hand a role to a service"
   ],
   [
    "Policy boundary",
    "Ceiling on permissions, grants nothing"
   ]
  ]
 },
 "5": {
  ...
  "table": [
   ...
   [
    "Reserved",
    "Commit 1-3y for 30-60% off"
   ],
   [
    "Spot",
    "Biggest discount, interruptible"
   ],
   [
    "Savings Plan",
    "Commit $/hr across compute"
   ],
   [
    "Dedicated Host",
    "Bring-your-own-license, isolation"
   ]
  ]
 },
 "6": {
  ...
  "table": [
   ...
   [
    "gp2/gp3",
    "General-purpose boot + apps"
   ],
   [
    "io1/io2",
    "High IOPS DBs, latency-sensitive"
   ],
   [
    "st1/sc1",
    "Big sequential data, cost-driven"
   ],
   [
    "Instance Store",
    "Cache/scratch, never durable"
   ],
   [
    "Snapshots",
    "Backup + AMI source, in S3"
   ],
   [
    "Storage",
    "Shares?",
 ...
 "7": {
  ...
  "table": [
   ...
   [
    "Standard-IA",
    "Occasional access, cheap storage"
   ],
   [
    "One-Zone IA",
    "Cheapest single-AZ, regenerable data"
   ],
   [
    "Glacier Flexible",
    "Archive, minutes to retrieve"
   ],
   [
    "Glacier Deep Archive",
    "Years, hours to retrieve"
   ]
  ]
 },
 "8": {
  ...
  "table": [
   ...
   [
    "Lifecycle",
    "Automatic class transitions/expiry"
   ],
   [
    "Bucket policy",
    "Cross-account / public / conditional access"
   ],
   [
    "Replication",
    "Copy objects to another bucket/region"
   ],
   [
    "Static hosting",
    "Serve a plain HTML site from S3"
   ],
   [
    "Presigned URL",
    "Time-limited access to one object"
   ]
  ]
 },
 "9": {
 ...
 "10": {
  ...
  "table": [
   ...
   [
    "NACL",
    "Stateless, allow + deny, ordered"
   ],
   [
    "IGW",
    "Public internet in/out"
   ],
   [
    "NAT Gateway",
 ...
 "13": {
  ...
  "table": [
   ...
   [
    "RDS",
    "Managed relational, familiar SQL"
   ],
   [
    "Aurora",
    "MySQL/Postgres + scale + serverless"
   ],
   [
    "ElastiCache",
 ...
 "15": {
  ...
  "table": [
   ...
   [
    "Transactions",
    "All-or-nothing multi-item"
   ],
   [
    "DAX",
    "Caching, hot-key relief"
   ],
   [
    "Global tables",
 ...
 "16": {
  ...
  "table": [
   ...
   [
    "OAC",
    "Lock S3 origin to CloudFront"
   ],
   [
    "Signed URLs",
    "Private, time-limited content"
   ],
   [
    "Lambda@Edge",
    "Edge logic on requests/responses"
   ],
   [
    "Global Accelerator",
    "Fast global TCP/UDP + static IPs"
   ]
  ]
 },
 "17": {
 ...
 "18": {
  ...
  "table": [
   ...
   [
    ...
    "Guarantee, avoid throttling"
   ],
   [
    "Provisioned concurrency",
    "Pre-warm, kill cold starts"
   ],
   [
    "Layers",
    "Share deps, shrink packages"
   ],
   [
    "VPC config",
    "Subnets + SG for private access"
   ],
   [
    "DLQ/destination",
    "Catch async failures"
   ]
  ]
 },
 "20": {
 ...
 "23": {
  ...
  "table": [
   ...
   [
    "Firehose",
    "Buffered delivery to destinations"
   ],
   [
    "Data Analytics",
 ...
 "26": {
  ...
  "table": [
   ...
   [
    "StackSets",
    "Same stack, many accounts"
   ],
   [
    "DeletionPolicy",
    "What survives stack delete"
   ]
  ]
 },
 "27": {
  ...
  "table": [
   ...
   [
    "CodeDeploy",
    "Ship to EC2/Lambda/ECS"
   ],
   [
    "CodePipeline",
    "Orchestrate the whole chain"
   ]
  ]
 },
 "28": {
 ...
 "29": {
  ...
  "table": [
   ...
   [
    "X-Ray",
    "Per-request trace across services"
   ],
   [
    "CloudTrail",
